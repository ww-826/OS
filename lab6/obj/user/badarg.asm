...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	5f450513          	addi	a0,a0,1524 # 800628 <main+0xee>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	5f250513          	addi	a0,a0,1522 # 800648 <main+0x10e>
...
exit(int error_code) {
  ...
  800136:	51e50513          	addi	a0,a0,1310 # 800650 <main+0x116>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800190:	4dc78793          	addi	a5,a5,1244 # 800668 <main+0x12e>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001e8:	644a8a93          	addi	s5,s5,1604 # 800828 <main+0x2ee>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80040a:	57a78793          	addi	a5,a5,1402 # 800980 <error_string>
  ...
  80041e:	27e60613          	addi	a2,a2,638 # 800698 <main+0x15e>
  ...
  800430:	25c60613          	addi	a2,a2,604 # 800688 <main+0x14e>
  ...
  8004a2:	1e3d8d93          	addi	s11,s11,483 # 800681 <main+0x147>
  ...
  8004de:	1a650513          	addi	a0,a0,422 # 800680 <main+0x146>
  ...
  8004f2:	192d8d93          	addi	s11,s11,402 # 800680 <main+0x146>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  80053e:	e822                	sd	s0,16(sp)
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800540:	c01ff0ef          	jal	800140 <fork>
  ...
  800566:	bddff0ef          	jal	800142 <waitpid>
  80056a:	e115                	bnez	a0,80058e <main+0x54>
  80056c:	4732                	lw	a4,12(sp)
  80056e:	67b1                	lui	a5,0xc
  800570:	eaf78793          	addi	a5,a5,-337 # beaf <_start-0x7f4171>
  ...
  8005a8:	a7fff0ef          	jal	800026 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  ...
  8005c6:	a61ff0ef          	jal	800026 <__panic>
    assert(waitpid(-1, NULL) != 0);
  ...
  8005e4:	a43ff0ef          	jal	800026 <__panic>
    assert(pid > 0);
  ...
  800602:	a25ff0ef          	jal	800026 <__panic>
        cprintf("fork ok.\n");
  ...
  800614:	347d                	addiw	s0,s0,-1
            yield();
  800616:	b2fff0ef          	jal	800144 <yield>
        for (i = 0; i < 10; i ++) {
  80061a:	fc6d                	bnez	s0,800614 <main+0xda>
        exit(0xbeaf);
  80061c:	6531                	lui	a0,0xc
  80061e:	eaf50513          	addi	a0,a0,-337 # beaf <_start-0x7f4171>
  800622:	b09ff0ef          	jal	80012a <exit>
