...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	5b450513          	addi	a0,a0,1460 # 8005e8 <main+0xc4>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	5b250513          	addi	a0,a0,1458 # 800608 <main+0xe4>
...
exit(int error_code) {
  ...
  800126:	4ee50513          	addi	a0,a0,1262 # 800610 <main+0xec>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017a:	4b278793          	addi	a5,a5,1202 # 800628 <main+0x104>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d2:	626a8a93          	addi	s5,s5,1574 # 8007f4 <main+0x2d0>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f4:	56078793          	addi	a5,a5,1376 # 800950 <error_string>
  ...
  800408:	25460613          	addi	a2,a2,596 # 800658 <main+0x134>
  ...
  80041a:	23260613          	addi	a2,a2,562 # 800648 <main+0x124>
  ...
  80048c:	1b9d8d93          	addi	s11,s11,441 # 800641 <main+0x11d>
  ...
  8004c8:	17c50513          	addi	a0,a0,380 # 800640 <main+0x11c>
  ...
  8004dc:	168d8d93          	addi	s11,s11,360 # 800640 <main+0x11c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  80052e:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  800530:	b71ff0ef          	jal	8000a0 <cprintf>
    int i;
  ...
  800564:	ac3ff0ef          	jal	800026 <__panic>
  ...
  800588:	2685                	addiw	a3,a3,1 # 100001 <_start-0x70001f>
  ...
  8005c0:	ae1ff0ef          	jal	8000a0 <cprintf>
