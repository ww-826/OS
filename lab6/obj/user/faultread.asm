...
exit(int error_code) {
  ...
  8000c4:	40850513          	addi	a0,a0,1032 # 8004c8 <main+0x6>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800118:	3cc78793          	addi	a5,a5,972 # 8004e0 <main+0x1e>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800170:	474a8a93          	addi	s5,s5,1140 # 8005e0 <main+0x11e>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800392:	3aa78793          	addi	a5,a5,938 # 800738 <error_string>
  ...
  8003a6:	17660613          	addi	a2,a2,374 # 800518 <main+0x56>
  ...
  8003b8:	15460613          	addi	a2,a2,340 # 800508 <main+0x46>
  ...
  80042a:	0d3d8d93          	addi	s11,s11,211 # 8004f9 <main+0x37>
  ...
  800466:	09650513          	addi	a0,a0,150 # 8004f8 <main+0x36>
  ...
  80047a:	082d8d93          	addi	s11,s11,130 # 8004f8 <main+0x36>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
