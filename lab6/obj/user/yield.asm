...
cputch(int c, int *cnt) {
  ...
  80002a:	e42e                	sd	a1,8(sp)
    sys_putc(c);
  80002c:	08e000ef          	jal	8000ba <sys_putc>
    (*cnt) ++;
...
exit(int error_code) {
  ...
  8000cc:	47050513          	addi	a0,a0,1136 # 800538 <main+0x6a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800124:	43078793          	addi	a5,a5,1072 # 800550 <main+0x82>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80017c:	550a8a93          	addi	s5,s5,1360 # 8006c8 <main+0x1fa>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80039e:	48678793          	addi	a5,a5,1158 # 800820 <error_string>
  ...
  8003b2:	1da60613          	addi	a2,a2,474 # 800588 <main+0xba>
  ...
  8003c4:	1b860613          	addi	a2,a2,440 # 800578 <main+0xaa>
  ...
  800436:	137d8d93          	addi	s11,s11,311 # 800569 <main+0x9b>
  ...
  800472:	0fa50513          	addi	a0,a0,250 # 800568 <main+0x9a>
  ...
  800486:	0e6d8d93          	addi	s11,s11,230 # 800568 <main+0x9a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  8004d6:	c03ff0ef          	jal	8000d8 <getpid>
  ...
  8004ea:	4495                	li	s1,5
        yield();
  8004ec:	bebff0ef          	jal	8000d6 <yield>
