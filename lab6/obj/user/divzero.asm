...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	53450513          	addi	a0,a0,1332 # 800568 <main+0x44>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	53250513          	addi	a0,a0,1330 # 800588 <main+0x64>
...
exit(int error_code) {
  ...
  800126:	46e50513          	addi	a0,a0,1134 # 800590 <main+0x6c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017a:	43278793          	addi	a5,a5,1074 # 8005a8 <main+0x84>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d2:	502a8a93          	addi	s5,s5,1282 # 8006d0 <main+0x1ac>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f4:	43878793          	addi	a5,a5,1080 # 800828 <error_string>
  ...
  800408:	1d460613          	addi	a2,a2,468 # 8005d8 <main+0xb4>
  ...
  80041a:	1b260613          	addi	a2,a2,434 # 8005c8 <main+0xa4>
  ...
  80048c:	139d8d93          	addi	s11,s11,313 # 8005c1 <main+0x9d>
  ...
  8004c8:	0fc50513          	addi	a0,a0,252 # 8005c0 <main+0x9c>
  ...
  8004dc:	0e8d8d93          	addi	s11,s11,232 # 8005c0 <main+0x9c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800548:	b59ff0ef          	jal	8000a0 <cprintf>
    panic("FAIL: T.T\n");
