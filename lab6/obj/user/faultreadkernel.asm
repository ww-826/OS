...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	52450513          	addi	a0,a0,1316 # 800558 <main+0x34>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	52250513          	addi	a0,a0,1314 # 800578 <main+0x54>
...
exit(int error_code) {
  ...
  800126:	45e50513          	addi	a0,a0,1118 # 800580 <main+0x5c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017a:	42278793          	addi	a5,a5,1058 # 800598 <main+0x74>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d2:	50aa8a93          	addi	s5,s5,1290 # 8006d8 <main+0x1b4>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f4:	44078793          	addi	a5,a5,1088 # 800830 <error_string>
  ...
  800408:	1c460613          	addi	a2,a2,452 # 8005c8 <main+0xa4>
  ...
  80041a:	1a260613          	addi	a2,a2,418 # 8005b8 <main+0x94>
  ...
  80048c:	129d8d93          	addi	s11,s11,297 # 8005b1 <main+0x8d>
  ...
  8004c8:	0ec50513          	addi	a0,a0,236 # 8005b0 <main+0x8c>
  ...
  8004dc:	0d8d8d93          	addi	s11,s11,216 # 8005b0 <main+0x8c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800536:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  800538:	b69ff0ef          	jal	8000a0 <cprintf>
    panic("FAIL: T.T\n");
  ...
  80054e:	ad9ff0ef          	jal	800026 <__panic>
