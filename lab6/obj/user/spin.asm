...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	5dc50513          	addi	a0,a0,1500 # 800610 <main+0xce>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	5da50513          	addi	a0,a0,1498 # 800630 <main+0xee>
...
exit(int error_code) {
  ...
  80013c:	50050513          	addi	a0,a0,1280 # 800638 <main+0xf6>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800198:	4bc78793          	addi	a5,a5,1212 # 800650 <main+0x10e>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f0:	694a8a93          	addi	s5,s5,1684 # 800880 <main+0x33e>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800412:	5ca78793          	addi	a5,a5,1482 # 8009d8 <error_string>
  ...
  800426:	25e60613          	addi	a2,a2,606 # 800680 <main+0x13e>
  ...
  800438:	23c60613          	addi	a2,a2,572 # 800670 <main+0x12e>
  ...
  8004aa:	1c3d8d93          	addi	s11,s11,451 # 800669 <main+0x127>
  ...
  8004e6:	18650513          	addi	a0,a0,390 # 800668 <main+0x126>
  ...
  8004fa:	172d8d93          	addi	s11,s11,370 # 800668 <main+0x126>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800550:	b51ff0ef          	jal	8000a0 <cprintf>
    if ((pid = fork()) == 0) {
  800554:	bf3ff0ef          	jal	800146 <fork>
  ...
  800572:	b2fff0ef          	jal	8000a0 <cprintf>
    ...
    yield();
  800576:	bd5ff0ef          	jal	80014a <yield>
    yield();
  80057a:	bd1ff0ef          	jal	80014a <yield>
    yield();
  80057e:	bcdff0ef          	jal	80014a <yield>
  ...
  800590:	bbdff0ef          	jal	80014c <kill>
  ...
  8005a6:	4581                	li	a1,0
  8005a8:	ba1ff0ef          	jal	800148 <waitpid>
  ...
  8005ec:	a3bff0ef          	jal	800026 <__panic>
    assert((ret = kill(pid)) == 0);
  ...
  80060a:	a1dff0ef          	jal	800026 <__panic>
