...
main(void) {
  ...
  80052c:	ac07ac23          	sw	zero,-1320(a5) # 801000 <zero>
    cprintf("value is %d.\n", 1 / zero);
  800530:	00001717          	auipc	a4,0x1
  800534:	ad072703          	lw	a4,-1328(a4) # 801000 <zero>
main(void) {
  800538:	e406                	sd	ra,8(sp)
    cprintf("value is %d.\n", 1 / zero);
  80053a:	0017079b          	addiw	a5,a4,1
  80053e:	0037b793          	sltiu	a5,a5,3
  800542:	0007059b          	sext.w	a1,a4
  800546:	e391                	bnez	a5,80054a <main+0x24>
  800548:	4581                	li	a1,0
  80054a:	00000517          	auipc	a0,0x0
  80054e:	15e50513          	addi	a0,a0,350 # 8006a8 <main+0x182>
  800552:	b4fff0ef          	jal	8000a0 <cprintf>
    panic("FAIL: T.T\n");
  800556:	00000617          	auipc	a2,0x0
  80055a:	16260613          	addi	a2,a2,354 # 8006b8 <main+0x192>
  80055e:	45a9                	li	a1,10
  800560:	00000517          	auipc	a0,0x0
  800564:	16850513          	addi	a0,a0,360 # 8006c8 <main+0x1a2>
  800568:	abfff0ef          	jal	800026 <__panic>
