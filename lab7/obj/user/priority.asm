...
000000000080015c <lab6_set_priority>:
}
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800204:	718a8a93          	addi	s5,s5,1816 # 800918 <main+0x3b0>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800426:	64e78793          	addi	a5,a5,1614 # 800a70 <error_string>
...
main(void) {
  ...
  80059a:	bc3ff0ef          	jal	80015c <lab6_set_priority>
  ...
  8005b2:	c561                	beqz	a0,80067a <main+0x112>
          ...
          if (pids[i] < 0) {
  8005b4:	12054863          	bltz	a0,8006e4 <main+0x17c>
     for (i = 0; i < TOTAL; i ++) {
  ...
  80063a:	2ba50513          	addi	a0,a0,698 # 8008f0 <main+0x388>
  ...
  800682:	6489                	lui	s1,0x2
                    if(acc[i]%4000==0) {
  800684:	6405                	lui	s0,0x1
               lab6_set_priority(i + 1);
  800686:	ad7ff0ef          	jal	80015c <lab6_set_priority>
                    if(acc[i]%4000==0) {
  80068a:	fa04041b          	addiw	s0,s0,-96 # fa0 <_start-0x7ff080>
               acc[i] = 0;
  80068e:	000aa023          	sw	zero,0(s5)
                        if((time=gettime_msec())>MAX_TIME) {
  800692:	71048493          	addi	s1,s1,1808 # 2710 <_start-0x7fd910>
  800696:	000aa683          	lw	a3,0(s5)
  80069a:	2685                	addiw	a3,a3,1
     for (i = 0; i != 200; ++ i)
  80069c:	0c800713          	li	a4,200
          j = !j;
  8006a0:	47b2                	lw	a5,12(sp)
     for (i = 0; i != 200; ++ i)
  8006a2:	377d                	addiw	a4,a4,-1
          j = !j;
  8006a4:	0017b793          	seqz	a5,a5
  8006a8:	c63e                	sw	a5,12(sp)
     for (i = 0; i != 200; ++ i)
  8006aa:	fb7d                	bnez	a4,8006a0 <main+0x138>
                    if(acc[i]%4000==0) {
  8006ac:	0286f7bb          	remuw	a5,a3,s0
  8006b0:	c399                	beqz	a5,8006b6 <main+0x14e>
  8006b2:	2685                	addiw	a3,a3,1
  8006b4:	b7e5                	j	80069c <main+0x134>
  8006b6:	00daa023          	sw	a3,0(s5)
                        if((time=gettime_msec())>MAX_TIME) {
  8006ba:	aa1ff0ef          	jal	80015a <gettime_msec>
  8006be:	892a                	mv	s2,a0
  8006c0:	fca4dbe3          	bge	s1,a0,800696 <main+0x12e>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  8006c4:	a95ff0ef          	jal	800158 <getpid>
  8006c8:	000aa603          	lw	a2,0(s5)
  8006cc:	85aa                	mv	a1,a0
  8006ce:	86ca                	mv	a3,s2
  8006d0:	00000517          	auipc	a0,0x0
  8006d4:	18050513          	addi	a0,a0,384 # 800850 <main+0x2e8>
  8006d8:	9c9ff0ef          	jal	8000a0 <cprintf>
                            exit(acc[i]);
  8006dc:	000aa503          	lw	a0,0(s5)
  8006e0:	a5dff0ef          	jal	80013c <exit>
  8006e4:	00001417          	auipc	s0,0x1
  8006e8:	93040413          	addi	s0,s0,-1744 # 801014 <pids+0x14>
          if (pids[i] > 0) {
  8006ec:	4088                	lw	a0,0(s1)
  8006ee:	00a05463          	blez	a0,8006f6 <main+0x18e>
               kill(pids[i]);
  8006f2:	a65ff0ef          	jal	800156 <kill>
     for (i = 0; i < TOTAL; i ++) {
  8006f6:	0491                	addi	s1,s1,4
  8006f8:	fe849ae3          	bne	s1,s0,8006ec <main+0x184>
     panic("FAIL: T.T\n");
  8006fc:	00000617          	auipc	a2,0x0
  800700:	1fc60613          	addi	a2,a2,508 # 8008f8 <main+0x390>
  800704:	04b00593          	li	a1,75
  800708:	00000517          	auipc	a0,0x0
  80070c:	20050513          	addi	a0,a0,512 # 800908 <main+0x3a0>
  800710:	917ff0ef          	jal	800026 <__panic>
