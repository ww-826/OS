...
0000000000800030 <__warn>:
  ...
  800042:	6a250513          	addi	a0,a0,1698 # 8006e0 <main+0x94>
  ...
  800064:	67850513          	addi	a0,a0,1656 # 8006d8 <main+0x8c>
...
0000000000800074 <cputch>:
  ...
  80007a:	0ba000ef          	jal	800134 <sys_putc>
...
000000000080008c <vcprintf>:
  ...
  80009e:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f5f79>
...
00000000008000b2 <cprintf>:
  ...
  8000d0:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f5f79>
...
000000000080012c <sys_yield>:
  80012c:	4529                	li	a0,10
...
0000000000800156 <exit>:
  ...
  800162:	5a250513          	addi	a0,a0,1442 # 800700 <main+0xb4>
  800166:	f4dff0ef          	jal	8000b2 <cprintf>
  80016a:	a001                	j	80016a <exit+0x14>

000000000080016c <yield>:
  80016c:	b7c1                	j	80012c <sys_yield>

000000000080016e <getpid>:
  80016e:	b7c9                	j	800130 <sys_getpid>
...
0000000000800226 <printnum>:
  ...
  80026a:	51a78793          	addi	a5,a5,1306 # 800780 <main+0x134>
...
0000000000800296 <vprintfmt>:
  ...
  8002c8:	744b0b13          	addi	s6,s6,1860 # 800a08 <main+0x3bc>
  ...
  800502:	66278793          	addi	a5,a5,1634 # 800b60 <error_string>
  ...
  800516:	29e68693          	addi	a3,a3,670 # 8007b0 <main+0x164>
  ...
  80052a:	27a68693          	addi	a3,a3,634 # 8007a0 <main+0x154>
  ...
  8005a4:	1f9a8a93          	addi	s5,s5,505 # 800799 <main+0x14d>
  8005a8:	547d                	li	s0,-1
...
000000000080064c <main>:
  ...
  800654:	b1bff0ef          	jal	80016e <getpid>
  800658:	85aa                	mv	a1,a0
  80065a:	00000517          	auipc	a0,0x0
  80065e:	33650513          	addi	a0,a0,822 # 800990 <main+0x344>
  800662:	a51ff0ef          	jal	8000b2 <cprintf>
  800666:	4401                	li	s0,0
  800668:	4495                	li	s1,5
  80066a:	b03ff0ef          	jal	80016c <yield>
  80066e:	b01ff0ef          	jal	80016e <getpid>
